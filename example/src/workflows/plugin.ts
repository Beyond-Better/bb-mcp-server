 ...
 */
const exampleWorkflowsPlugin: WorkflowPlugin = {
 ...
 */
export function createExampleWorkflowsPlugin(dependencies: WorkflowPluginDependencies): WorkflowPlugin {
 ...
 * ✅ Plugin architecture compliance: Implements WorkflowPlugin interface
