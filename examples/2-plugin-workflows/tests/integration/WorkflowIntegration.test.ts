...
describe('Workflow Integration Tests', () => {
  ...
  describe('Plugin Discovery and Registration', () => {
    it('should discover WorkflowPlugin correctly', () => {
      ...
      assertEquals(WorkflowPlugin.description, 'Comprehensive workflow demonstrations with multi-step processing and state management');
  ...
  describe('Workflow Categories and Organization', () => {
    it('should have workflows in appropriate categories', () => {
      ...
      const contentGenerationWorkflow = workflows.find(w => w.name === 'content_generation_pipeline');
  ...
  describe('End-to-End Workflow Execution', () => {
    ...
    it('should execute file management workflow end-to-end', async () => {
      const workflow = WorkflowPlugin.workflows?.find(w => w.name === 'file_management_lifecycle');
      assertExists(workflow);
    ...
    it('should execute content generation workflow end-to-end', async () => {
      const workflow = WorkflowPlugin.workflows?.find(w => w.name === 'content_generation_pipeline');
      assertExists(workflow);
  ...
  describe('Tools and Workflows Integration', () => {
    ...
    it('should demonstrate tool vs workflow usage patterns', async () => {
      ...
      const fileWorkflow = WorkflowPlugin.workflows?.find(w => w.name === 'file_management_lifecycle');
