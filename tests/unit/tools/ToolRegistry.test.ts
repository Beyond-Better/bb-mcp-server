  ...
  describe('Tool Registration', () => {
    ...
    it('should create Zod validator from input schema', () => {
      const definition: ToolDefinition<
        { value: z.ZodNumber; optional: z.ZodOptional<z.ZodString> }
      > = {
        title: 'Schema Test',
      ...
      const handler: ToolHandler<{ value: z.ZodNumber; optional: z.ZodOptional<z.ZodString> }> =
        async (args: { value: number; optional?: string | undefined }) => ({
