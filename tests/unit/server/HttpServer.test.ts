...
import type { HttpServerConfig, HttpServerDependencies } from '../../../src/lib/server/HttpServer.ts';
...
async function makeRequest(port: number, path: string, options: RequestInit = {}): Promise<Response> {
