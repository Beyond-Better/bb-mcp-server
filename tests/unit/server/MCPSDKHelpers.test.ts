...
// Import types
import type { RegisteredTool, CreateMessageRequest, ElicitInputRequest } from '../../../src/lib/types/BeyondMcpTypes.ts';
...
describe('MCPSDKHelpers', () => {
  ...
  describe('Tool Overview Generation', () => {
    it('should generate overview for multiple tools', () => {
      ...
      assert(overview.includes('1. **echo**: Echoes back the input message (core) [testing, core] v1.0.0'));
      assert(overview.includes('2. **complex_tool**: Performs complex data analysis with multiple parameters (analysis) [data, analysis, complex]'));
